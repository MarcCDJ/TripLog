...
namespace TripLog.Services
{
    public class XamarinFormsNavService : INavService
    {
        ...
        {
            await NavigateToView(typeof(TVM)).ConfigureAwait(false);
        ...
        async Task NavigateToView(Type viewModelType)
        {
            ...
            await XamarinFormsNav.PushAsync(view, true).ConfigureAwait(false);
        }

        void OnCanGoBackChanged() => CanGoBackChanged?.Invoke(this, new PropertyChangedEventArgs(nameof(CanGoBack)));
    }
}
